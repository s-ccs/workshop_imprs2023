...
# ╔═╡ b30b7bbc-44c9-11ef-3479-2d0fd920e453
using Agents,Random

# ╔═╡ 007798d7-7e5d-4b5d-a31b-8dfa8674e0a9
using PlutoUI

# ╔═╡ 7b4bb2de-1f64-45ec-9952-3a84ae1910a5
md"""
# !🧟Zombie Outbreak🧟!
"""

# ╔═╡ 141ec83c-9088-4393-a1a8-e2b310de31a2
md"""
## Define your own map
"""

# ╔═╡ bb7e4181-e254-477f-a245-49ac05d99abf
md"""
1. Goto: [openstreetmap](https://www.openstreetmap.org/export#map=17/48.77318/9.15668)
2. select the map area you want to simulate on
3. click "export" in top left, and choose "overpass-api"
4. Paste the link below

"""

# ╔═╡ eb43b363-c308-4de7-907c-43b961dec783
@bind osm_api_call PlutoUI.TextField(70,default="https://overpass-api.de/api/map?bbox=9.14760,48.76982,9.16576,48.77653")

# ╔═╡ d5cc4b8a-ffd6-46fe-8daa-8e75c96c7032
md"""
## Define what a zombie is, and what zombies do
"""

# ╔═╡ 1558d000-d98c-4a69-adc9-a06d9916bd04
...
# ╔═╡ 77d3bccc-99f0-4281-bc3b-459bb5772e8d
...
# ╔═╡ b01ad42a-19e3-465b-967e-a6e05b9e7611
osmmap = download(osm_api_call,tempname()*".osm");

# ╔═╡ 8f3cb04d-5722-4dfd-9b4e-9a95471a0a57
function initialise_zombies(; seed = 1234)
    properties = Dict(:dt => 1 / 60)
    model = StandardABM(
        Zombie,
        OpenStreetMapSpace(osmmap);
...
# ╔═╡ eda40df0-60af-4403-b5d9-2b4c4bd5eb77
begin
	using CairoMakie, OSMMakie
	
	
	zombie_color(agent) = agent.infected ? :red : :black
	zombie_size(agent) = agent.infected ? 10 : 8
	zombies = initialise_zombies()
	
	abmvideo("outbreak.mp4", zombies;
	    title = "Zombie outbreak", framerate = 15, frames = 100,
	    agent_color = zombie_color, agent_size = zombie_size
	)
	PlutoUI.LocalResource("outbreak.mp4")
end

# ╔═╡ 6e39060e-d02b-4592-8410-634d0607d99a
md"""
## Simulate & make a movie
"""
...
manifest_format = "2.0"
project_hash = "6dd90bd0ca4f9b070749d681f9fc85229bffeccb"
...
git-tree-sha1 = "52a19854ab4c963dd67b78026f6ba721348bb503"
...
deps = ["ExprTools", "MacroTools", "PrecompileTools", "SumTypes"]
git-tree-sha1 = "13a3db5684411730a4e4e52cea8511bff184f649"
...
git-tree-sha1 = "2b265fc2044e2c15477da9fa3c87754086735841"
...
git-tree-sha1 = "5aee720ca3bf079042ae3cf018e25e9c502ed778"
